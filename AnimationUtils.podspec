#
#  Be sure to run `pod spec lint AnimationUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "AnimationUtils"
  s.version      = "1.0.0"
  s.summary      = "AnimationUtils for iOS."
  ...
  s.author             = { "liulinjun2code" => "510771774@qq.com" }
  # Or just: s.author    = "liulinjun2code"
  # s.authors            = { "liulinjun2code" => "510771774@qq.com" }
  # s.social_media_url   = "http://twitter.com/liulinjun2code"
